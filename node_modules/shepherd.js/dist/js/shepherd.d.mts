...
export declare class Step extends Evented {
	 ...
	 * @private
	 */
	_createTooltipContent(): HTMLDialogElement;
	/**
...
export type ModalRadiusType = number | {
	topLeft?: number;
	bottomLeft?: number;
	bottomRight?: number;
	topRight?: number;
...
export interface ShepherdModalAPI {
	...
	destroy: () => void;
	hide: () => void;
	positionModal: (modalOverlayOpeningPadding?: number, modalOverlayOpeningRadius?: ModalRadiusType, modalOverlayOpeningXOffset?: number, modalOverlayOpeningYOffset?: number, scrollParent?: HTMLElement | null, targetElement?: HTMLElement | null, extraHighlights?: HTMLElement[]) => void;
