...
var l = { defaultMerge: Symbol("deepmerge-ts: default merge"), skip: Symbol("deepmerge-ts: skip") };
function c(t2, e2) {
  return e2;
}
function a(t2, e2) {
...
function ce(t2, n2) {
  ...
  return n2.options.title && o2.append(function(t3, n3) {
    ...
    }, type: "button" }, ne("span", { "aria-hidden": "true" }, "×"));
...
shepherd.js/dist/js/shepherd.mjs:
  (*! shepherd.js 15.0.0 *)
*/
